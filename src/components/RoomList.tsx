...
const RoomList = () => {
  ...
  const { isGuest } = useUser(); // Check if the user is a guest
...
//               onClick={() => enterRoom(room._id, room.isActive)} // Check if the room is locked
//               style={{
//                 cursor: room.isActive && isGuest ? "not-allowed" : "pointer",
//                 color: room.isActive && isGuest ? "gray" : "blue",
//                 textDecoration: "underline",
//               }}
//             >
//               {room.name} {room.isActive && isGuest ? "(Locked)" : "(Open)"}
//             </span>
//             {/* Display message if the room is locked */}
//             {lockedRoomId === room._id && (
