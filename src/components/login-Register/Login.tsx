...
const Login = () => {
  ...
  const onLogin = async () => {
    ...
    // Om inloggningen lyckas, uppdatera användaren i UserContext
    if (result.success) {
      setSuccess(result.message);
      setUser(result.user); // Sätter användaruppgifterna i UserContext
      navigate("/channel"); // Navigera till channel-sidan
    } else {
